...
FROM ubnt/unms:1.1.0-beta.4 as unms
FROM ubnt/unms:1.1.0-beta.4 as unms-nginx
FROM ubnt/unms-netflow:1.1.0-beta.4 as unms-netflow
FROM ubnt/unms-crm:3.1.0-beta.4 as unms-crm
...
ENV PATH=/home/app/unms/node_modules/.bin:$PATH:/usr/lib/postgresql/9.6/bin \
  ...
  QUIET_MODE=0 \
  WS_PORT=6443 \
  PUBLIC_HTTPS_PORT=6443 \
  PUBLIC_WS_PORT=6443 \
  UNMS_NETFLOW_PORT=2055 \
  SECURE_LINK_SECRET=enigma \
  SSL_CERT=""

EXPOSE 6080 6443 2055/udp
